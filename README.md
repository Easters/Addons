...
Ascension Compatibility: Fully optimized to handle custom UI elements and hooks found on the Path to Ascension private server.

Built-in Configuration Panel: Easily customize font sizes and text positioning (Bottom, Center, Top) via the interface options menu.
